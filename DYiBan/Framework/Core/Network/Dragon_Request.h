...
@class DragonRequest;
typedef void(^DragonRequestBlock)(DragonRequest *req);
typedef DragonRequest*(^DragonRequestBlcokV)(void);
typedef DragonRequest*(^DragonRequestBlockN)(id key,...);
typedef DragonRequest*(^DragonRequestBlockS)(NSString *string);

@interface DragonRequest : ASIFormDataRequest
{
    NSUInteger          _state;
...
@property (nonatomic, readonly)DragonRequestBlockN  HEADER;//请求带头文件
@property (nonatomic, readonly)DragonRequestBlockN  FILE;//上传文件
@property (nonatomic, readonly)DragonRequestBlockN  PARAMS;//get请求url带参数post参数(传入的值为array)
@property (nonatomic, readonly)DragonRequestBlockN  PARAM;//get请求url带参数post参数
@property (nonatomic, readonly)DragonRequestBlockN  BODY;//post请求带body
