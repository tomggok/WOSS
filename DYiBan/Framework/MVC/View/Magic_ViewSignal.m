...
@implementation NSObject(MagicViewSignalResponder)
...
@interface MagicViewSignal(Private)
- (void)routes;
@end

@implementation MagicViewSignal
...
- (BOOL)boolValue
{
    if (self.returnValue == MagicViewSignal.YES_VALUE)
    {
        return YES;
    }else if (self.returnValue == MagicViewSignal.NO_VALUE)
    {
        return NO;
    }
    return NO;
...
- (void)returnYES
{
    self.returnValue = MagicViewSignal.YES_VALUE;
}

- (void)returnNO
{
    self.returnValue = MagicViewSignal.NO_VALUE;
}
