...
- (void)handleViewSignal_DragonViewController:(DragonViewSignal *)signal
{
    ...
    }else if ([signal is:[DragonViewController CREATE_VIEWS]])
    {
        ...
        DragonUIImageView *imageview = [[DragonUIImageView alloc]initWithImage:[UIImage imageNamed:@"scanweb.png"]];
        ...
        [self setDragonUIButton:btn setImageNorm:[UIImage imageNamed:@"btn_blank2_a"] setImageHigh:[UIImage imageNamed:@"btn_blank2_b"]  signal:[DYBYiMaTongViewController SCANBUTTON] setControl:self];
...
#pragma mark- 点击按钮
- (void)handleViewSignal_DYBYiMaTongViewController:(DragonViewSignal *)signal
{
