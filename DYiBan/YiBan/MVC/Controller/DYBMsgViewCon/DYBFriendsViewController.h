...
@interface DYBFriendsViewController : DYBBaseViewController
{
    ...
    DragonUITableView *_tbv_friends_myConcern_RecentContacts/*好友|我关注的|最近联系人tbv*/;
    ...
    DragonUIButton *_bt_DropDown/*下拉按钮*/,*_bt_cancelViews/*点击取消某视图*/;
    DYBCallView *_v_call;/*打电话界面*/;
    DragonUIButton *TraparentView;

//    BOOL _b_up;
    BOOL bPullDown,_b_isRequested/*是否请求过1号DragonRequest,避免输入账号密码登陆后在 CREATE_VIEWS 信号里请求后 又在 tabbar切换时 在 WILL_APPEAR 信号请求*/;
