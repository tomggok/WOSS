...
{
    DragonUIImageView *_imgV_classImg,*_imgV_dashed/*虚线*/,*_imgV_arrow/*右箭头*/,*_imgv_verticalDashedLine/*竖虚线*/,*_imgV_arrowUp/*tbv顶部的箭头*/ ;
    DragonUILabel *_lb_name,*_lb_classSizeTab/*班级人数标签*/,*_lb_classSize/*班级实际人数*/;
    DragonUIButton *_bt_gotoClassDetail/*进入班级详情*/,*_bt_announcement/*公告*/,*_bt_topic/*话题*/,*_bt_classList/*右上角班级列表*/;
