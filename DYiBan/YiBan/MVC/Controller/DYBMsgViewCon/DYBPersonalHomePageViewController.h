...
{
    DragonUIButton *_bt_friend,*_bt_visitor/*访客*/,*_bt_PhotoAlbum/*相册*/,*_bt_datum/*资料*/,*_bt_BirthdayReminder/*生日提醒*/,*_bt_sendDynamic/*发动态*/,*_bt_backToTop/*回顶部*/,*_bt_AddFriends,*_bt_sendPriLetter,*_bt_refresh;
    user *_user;//接口读出来的用户数据
    DragonUIImageView *_imgV_show/*顶部展示图*/,*_imgV_head;
    DragonUIScrollView *_scr_All/*self.view上盖的一层,也是封面的父视图*/,*_scr_showImgBack/*和展示图宽高一样的展示图背景*/;
