...
//        if(!_muA_data)
        {//HTTP请求,班级详情
            ...
            DragonRequest *request = [DYBHttpMethod message_chat_sixin:1 pageNum:10 type:@"0" userid:[_d_model objectForKey:@"userid"] maxid:@"0" last_id:@"0" isAlert:YES receive:self];
            [request setTag:1];
