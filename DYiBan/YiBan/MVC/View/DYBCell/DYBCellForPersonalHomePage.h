...
{
    DragonUIImageView *_imgV_head,*_imgV_headBack/*头像白色背景*/,*_imgV_icon/*动态cell左边的icon*/,*_imgV_SpreadDayViewBack/*展开的day视图的蓝色背景*/,*_imgV_footMark/*脚印*/,*_imgV_signRightView/*签名右边的图标*/;
    ...
    DragonUIButton *_bt_friend,*_bt_visitor/*访客*/,*_bt_PhotoAlbum/*相册*/,*_bt_datum/*资料*/,*_bt_BirthdayReminder/*生日提醒*/,*_bt_pushUp,*_bt_stamp/*踩*/,*_bt_pushUpNumsArea/*顶的人数区域*/,*_bt_stampNumsArea/*踩的人数区域*/;
...
@property (nonatomic,retain) DragonUIImageView *imgV_head;
@property (nonatomic,retain) DragonUIButton *bt_pushUpNumsArea,*bt_stamp;
