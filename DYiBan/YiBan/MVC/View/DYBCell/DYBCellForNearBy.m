...
//            }
        ...
        if (!_lb_distance) {
            _lb_distance=[[DragonUILabel alloc]initWithFrame:CGRectMake(self.frame.size.width-80, _lb_nickName.frame.origin.y, 150,50)];
            ...
            _lb_distance.textColor=[DragonCommentMethod color:51 green:51 blue:51 alpha:1];
        ...
        if (!_lb_time) {
            _lb_time=[[DragonUILabel alloc]initWithFrame:CGRectMake(0, _lb_newContent.frame.origin.y, 0,0)];
            ...
            _lb_time.textColor=[DragonCommentMethod color:170 green:170 blue:170 alpha:1];
