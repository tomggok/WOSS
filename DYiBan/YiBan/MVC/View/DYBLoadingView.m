...
//        DragonUIImageView *bgView = [[DragonUIImageView alloc] initWithFrame:frame];
...
//        RELEASE(bgView);
        ...
        DragonUIImageView *loadBgView = [[DragonUIImageView alloc] initWithFrame:CGRectMake((mainSize.width - img) / 2, (mainSize.height - img) / 2, img, img)];
//        [loadBgView setCenter:CGPointMake(, (mainSize.height) / 2)];
        ...
        imgView = [[DragonUIImageView alloc] initWithFrame:CGRectMake(0, 0, img, img)];
        ...
        /*
         ...
         DragonUIImageView *loadBgView = [[DragonUIImageView alloc] initWithFrame:CGRectMake(0, 0, 44, 44)];
         ...
         DragonUIImageView *imgView = [[DragonUIImageView alloc] initWithFrame:CGRectMake(6, 6, 32, 32)];
         [imgView setAnimationImages:imgArr];
         [imgView setAnimationDuration:.5f];
         [imgView startAnimating];
